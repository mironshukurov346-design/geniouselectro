...
function ProductCard({ product }) {
  ...
  const stepperBtnBase =
    'w-10 h-10 flex items-center justify-center text-gray-500 text-lg font-light transition-all duration-150';

  return (
    <div className="flex flex-col bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-md transition-shadow duration-200 mx-auto w-full">
      {/* Image */}
      ...
      <div className="flex items-center gap-2 px-5 pb-5 pt-3">
        ...
        <div className="flex items-center border border-gray-200 rounded-xl overflow-hidden select-none">
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.backgroundColor = '#C3974C';
        ...
        <button
          ...
          onMouseEnter={(e) => {
            if (!addedToCart) {
              e.currentTarget.style.backgroundColor = '#C3974C';
              e.currentTarget.style.color = '#fff';
              e.currentTarget.style.borderColor = '#C3974C';
            }
          }}
          onMouseLeave={(e) => {
            if (!addedToCart) {
  ...
  return (
    <section className="w-full max-w-6xl mx-auto px-6 py-10">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <button className="flex items-center gap-1.5 text-sm font-medium text-gray-700 border border-gray-300 rounded-xl px-4 py-2 hover:bg-gray-50 hover:border-gray-400 transition-all duration-150 active:scale-95">
          Посмотреть все
          <svg
      ...
      {/* Grid — gap-6 = 24px, kartalar to'liq kenglikda, mx-auto orqali markazlashgan */}
